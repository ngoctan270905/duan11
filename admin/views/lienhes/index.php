                            ...
                            <div class="h-100">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        ...
                                        <a href="?act=lienhes/create" class="btn btn-soft-success material-shadow-none">
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlspecialchars($lienhe['noi_dung']); ?>
                                                            </td>
                                                            <td><?php echo htmlspecialchars($lienhe['ngay_tao']); ?>
                                                            </td>
                                                            <td>
                                                                <?php
