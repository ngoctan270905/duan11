...
<head>
    <meta charset="utf-8" />
    <title>Sửa liên hệ | PhoneStore</title>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="live-preview">
                                            ...
                                            <form action="?act=lienhes/edit&id=<?php echo $lienhe['id']; ?>"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="email"
                                                                name="email" value="<?php echo $lienhe['email']; ?>"
                                                                required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="noi_dung"
                                                                name="noi_dung"
                                                                value="<?php echo $lienhe['noi_dung']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-select" id="trang_thai"
                                                                ...
                                                                <option
                                                                    <?php echo ($lienhe['trang_thai'] == '1') ? 'selected' : ''; ?>
                                                                    value="1">Hiện thị</option>
                                                                <option
                                                                    <?php echo ($lienhe['trang_thai'] == '0') ? 'selected' : ''; ?>
