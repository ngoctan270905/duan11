...
<head>
    ...
    <meta charset="utf-8" />
    <title>Thêm banner | PhoneStore</title>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="live-preview">
                                            <form action="?act=them-banners" method="POST" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            <label for="" class="form-label">Tiều đề</label>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="file" class="form-control" name="hinh_anh" placeholder="Chọn file" >
                                                            <span class="text-danger">
                                                        ...
                                                        <!-- <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="noi_dung" placeholder="Nội dung" >
                                                            <span class="text-danger">
